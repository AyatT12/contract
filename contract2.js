      ...
      $(this).on('change', function (e) {
        ...
        filesArr.forEach(function (f, index) {
          ...
          reader.onload = function (e) {
            var  html= "<div class='upload__img-box'><div style='background-image: url(" + e.target.result + ")' data-number='" + $(".upload__img-close").length + "' data-file='" + f.name + "' class='img-bg'><div class='upload__img-close'><img src='delete.png'></div></div></div>";
            imgWrap.append(html);
            iterator++;
          }
